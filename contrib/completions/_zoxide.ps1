...
Register-ArgumentCompleter -Native -CommandName 'zoxide' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'zoxide' {
            ...
            [CompletionResult]::new('alias', 'alias', [CompletionResultType]::ParameterValue, 'Manage directory aliases')
        ...
        'zoxide;alias' {
            ...
            [CompletionResult]::new('-V', '-V ', [CompletionResultType]::ParameterName, 'Print version')
            [CompletionResult]::new('--version', '--version', [CompletionResultType]::ParameterName, 'Print version')
            [CompletionResult]::new('add', 'add', [CompletionResultType]::ParameterValue, 'Add or update an alias')
            [CompletionResult]::new('rm', 'rm', [CompletionResultType]::ParameterValue, 'Remove an alias')
            [CompletionResult]::new('list', 'list', [CompletionResultType]::ParameterValue, 'List all aliases')
            [CompletionResult]::new('jump', 'jump', [CompletionResultType]::ParameterValue, 'Jump to an alias')
            [CompletionResult]::new('list-complete', 'list-complete', [CompletionResultType]::ParameterValue, 'List alias names for completion')
            break
        }
        'zoxide;alias;add' {
            [CompletionResult]::new('--resolve', '--resolve', [CompletionResultType]::ParameterName, 'Resolve symlinks when storing the path')
            [CompletionResult]::new('-h', '-h', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('--help', '--help', [CompletionResultType]::ParameterName, 'Print help')
            [CompletionResult]::new('-V', '-V ', [CompletionResultType]::ParameterName, 'Print version')
            [CompletionResult]::new('--version', '--version', [CompletionResultType]::ParameterName, 'Print version')
