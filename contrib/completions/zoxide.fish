...
complete -c zoxide -n "__fish_zoxide_needs_command" -f -a "alias" -d 'Manage directory aliases'
...
complete -c zoxide -n "__fish_zoxide_using_subcommand alias; and not __fish_seen_subcommand_from add rm list jump list-complete" -s h -l help -d 'Print help'
complete -c zoxide -n "__fish_zoxide_using_subcommand alias; and not __fish_seen_subcommand_from add rm list jump list-complete" -s V -l version -d 'Print version'
complete -c zoxide -n "__fish_zoxide_using_subcommand alias; and not __fish_seen_subcommand_from add rm list jump list-complete" -f -a "add" -d 'Add or update an alias'
complete -c zoxide -n "__fish_zoxide_using_subcommand alias; and not __fish_seen_subcommand_from add rm list jump list-complete" -f -a "rm" -d 'Remove an alias'
complete -c zoxide -n "__fish_zoxide_using_subcommand alias; and not __fish_seen_subcommand_from add rm list jump list-complete" -f -a "list" -d 'List all aliases'
complete -c zoxide -n "__fish_zoxide_using_subcommand alias; and not __fish_seen_subcommand_from add rm list jump list-complete" -f -a "jump" -d 'Jump to an alias'
complete -c zoxide -n "__fish_zoxide_using_subcommand alias; and not __fish_seen_subcommand_from add rm list jump list-complete" -f -a "list-complete" -d 'List alias names for completion'
complete -c zoxide -n "__fish_zoxide_using_subcommand alias; and __fish_seen_subcommand_from add" -l resolve -d 'Resolve symlinks when storing the path'
complete -c zoxide -n "__fish_zoxide_using_subcommand alias; and __fish_seen_subcommand_from add" -s h -l help -d 'Print help'
complete -c zoxide -n "__fish_zoxide_using_subcommand alias; and __fish_seen_subcommand_from add" -s V -l version -d 'Print version'
complete -c zoxide -n "__fish_zoxide_using_subcommand alias; and __fish_seen_subcommand_from rm" -s h -l help -d 'Print help'
complete -c zoxide -n "__fish_zoxide_using_subcommand alias; and __fish_seen_subcommand_from rm" -s V -l version -d 'Print version'
complete -c zoxide -n "__fish_zoxide_using_subcommand alias; and __fish_seen_subcommand_from list" -s h -l help -d 'Print help'
complete -c zoxide -n "__fish_zoxide_using_subcommand alias; and __fish_seen_subcommand_from list" -s V -l version -d 'Print version'
complete -c zoxide -n "__fish_zoxide_using_subcommand alias; and __fish_seen_subcommand_from jump" -s h -l help -d 'Print help'
complete -c zoxide -n "__fish_zoxide_using_subcommand alias; and __fish_seen_subcommand_from jump" -s V -l version -d 'Print version'
complete -c zoxide -n "__fish_zoxide_using_subcommand alias; and __fish_seen_subcommand_from list-complete" -s h -l help -d 'Print help'
complete -c zoxide -n "__fish_zoxide_using_subcommand alias; and __fish_seen_subcommand_from list-complete" -s V -l version -d 'Print version'
